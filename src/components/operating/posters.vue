<template>
  <div id="classify">
    <div class="zf"><i class="el-icon-house"></i>  >>  运营  >>  海报首页</div>
    <div class="zf1">
      <div>海报首页列表</div>
      <div class="zf2">
        <div class="zf4">
          <div class="zf5">
            <button><span>+</span> 添加海报首页</button>
          </div>
          <div>
            <template>
              <el-table
                ...
                <el-table-column
                  label="海报图片"
                  width="250">
                  <template slot-scope="scope"><img style="width:100%;height:100px" :src="scope.row.mc"/></template>
                </el-table-column>
                <el-table-column
                  prop="name"
                  label="海报名称"
            ...
            <div class="zf13">
              <div><button>批量启用</button></div>
              <div><button>批量禁用</button></div>
 ...
 export default {
    data() {
      return {
        tableData: [{
          date: 1,
          mc:require("../../assets/img/21.png"),
          name: "海报",
          name1: "http://www.youzhifang.net",
          name2: "是",
        }, {
          date: 1,
          mc:require("../../assets/img/21.png"),
