<template>
  <div id="classify">
    <div class="zf"><i class="el-icon-house"></i>  >>  运营  >>  优惠券</div>
    <div class="zf1">
      <div>优惠券列表</div>
      <div class="zf2">
        <div class="zf4">
          <div class="zf5">
            <button><span>+</span> 添加优惠券</button>
          </div>
          <div>
            <template>
              <el-table
                ...
                <el-table-column
                  label="优惠券图片"
                  width="120">
                  <template slot-scope="scope"><img style="width:30px;height:30px" :src="scope.row.mc"/></template>
                </el-table-column>
                <el-table-column
                  prop="name"
                  label="优惠券名称"
 ...
 export default {
    data() {
      return {
        tableData: [{
          date: 5,
          mc:require("../../assets/img/1.jpg"),
          name: "满100减10",
          name1: "是",
          name2: "2017-11-13 13:43:07",
          name3: "2017-11-13 13:43:07",
        }, {
          date: 5,
          mc:require("../../assets/img/1.jpg"),
          name: "满100减10",
