<template>
  <div id="classify">
    <div class="zf"><i class="el-icon-house"></i>  >>  商品  >>  商品资讯</div>
    <div class="zf1">
      <div>订单列表</div>
      <div class="zf2">
        <div class="zf4">
          <div class="zf5">
            <div>咨询人:<input type="text"/></div>
            <div>咨询商品:<input type="text"/></div>
            <div class="block">
              <span>资讯时间：</span>
              <el-date-picker
                v-model="value1"
 ...
 export default {
    data() {
      return {
        ...
        tableData: [{
          date: 27,
          mc:"2018-07-27 18:31:39",
          name: '奥克斯（AUX）1.5匹 变频 冷暖电辅 二级能效 壁挂式空调',
          name1: 'test1',
        }, {
          date: 27,
          mc:"2018-07-27 18:31:39",
