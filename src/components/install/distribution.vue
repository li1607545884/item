<template>
  <div id="classify">
    <div class="zf"><i class="el-icon-house"></i>  >>  设置  >>  配送方式</div>
    <div class="zf1">
      <div>配送方式列表</div>
      <div class="zf2">
        <div class="zf4">
          <div class="zf5">
            <button><span>+</span> 添加配送方式</button>
          </div>
          <div>
            <template>
              <el-table
                ...
                <el-table-column
                  label="排列顺序"
                  width="250">
                  <template slot-scope="scope"><input class="zf15" type="text" :value="scope.row.name5"/></template>
                </el-table-column>
                <el-table-column
                  prop="name1"
                  label="是否启用"
